...
dense1 = Dense(256, activation='relu')(input1)# input_shape = (3,1)은  행은 제외된 3열을 1개씩 자르겠다라고 정의됨
...
dense2 = Dense(256, activation='relu')(input2)# input_shape = (3,1)은  행은 제외된 3열을 1개씩 자르겠다라고 정의됨
...
model.fit([x1_train, x2_train], y1_train, 
          ...
          verbose=1, 
          batch_size= 1, epochs=5, callbacks=[early_stopping])
